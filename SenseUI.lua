...
gui.Combobox(awrefer, "ThemeColor", "Theme color", "Green", "Blue", "Red", "Purple", "Orange", "Pink");
...
local gs_fonts = {
	verdana_12 		= draw.CreateFont( "Verdana", 12, 0 ),
	verdana_12b 	= draw.CreateFont( "Verdana", 12.7, 700 ),
...
local function gs_endwindow(  )
	if gs_curchild.id ~= "" then
		...
		for i = 1, #gs_curchild.elements do
			...
			if gui.GetValue("ThemeColor") == 0 then
				r12, g12, b12 = 149, 184, 6;
			elseif gui.GetValue("ThemeColor") == 1 then
				r12, g12, b12 = 6, 132, 182;
			elseif gui.GetValue("ThemeColor") == 2 then
				r12, g12, b12 = 182, 6, 6;
			elseif gui.GetValue("ThemeColor") == 3 then
				r12, g12, b12 = 146, 6, 182;
			elseif gui.GetValue("ThemeColor") == 4 then
				r12, g12, b12 = 205, 107, 8;
			elseif gui.GetValue("ThemeColor") == 5 then
...
--
SenseUI.ColorPicker = gs_ColorPicker;
--
